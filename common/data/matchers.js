window.matchers = [
...

    {
        ...
        target: 'captain',
        matcher: /Aumenta.+ (el ATK|la HP|el RCV)|(el ATK|la HP|el RCV|el ATK y la HP|el ATK y el RCV|la HP y el RCV|el ATK, la HP y el RCV) de[^,]+(STR|DEX|QCK|PSY|INT)\b/i
    },
